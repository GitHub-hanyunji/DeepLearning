...
path = os.path.abspath(os.path.join(current_file_dir, '..'))
...
try:
    from classification import classification_project
    from detection import detection_project
    from segmentation import segmentation_project
    print("Module imported successfully")
except ImportError as e:
    print("ImportError:", e)

form_class = uic.loadUiType(os.path.abspath(os.path.join(current_file_dir, 'new4.ui')))[0]
