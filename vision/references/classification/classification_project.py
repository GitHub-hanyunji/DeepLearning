...
class WindowClass(QTabWidget, form_class):
    def __init__(self):
        ...
        acc_widget = self.findChild(QWidget, 'test_graph')
    ...
    def run_command(self,message):
        ...
        if(message=="train"):
            if(self.resultfolder_path!="" and self.folder_path!=""):
                args = classification_train.get_args_parser(self.folder_path,epoch,worker,lr,model,weight,self.device,self.resultfolder_path)
